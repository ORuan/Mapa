	function init () {
		...
		CriarMap(lat,long,nomes);
	}




/*function inserriten(nome_do_item, id, it, igv){
	var corrd = String(lt)+','+String(lg);
	var gerar 'gerarMapa('+coord+')';
}*/
function CriarMap(lat,long,nomes){
...
var pegarValores = function(){
	...
	for (var i=0;i<5;i++){
		...
		itens.setAttribute("onclick", init('long','lat','nomes'));	
